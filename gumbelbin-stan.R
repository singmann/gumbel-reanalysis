...
gumbelbin_stanvars <- "
   real gumbelbin_lpmf(int y, real mu, 
    ...
    pold = 1 - gumbelmin_cdf(cr, mu);
    pnew = 1 - gumbelmin_cdf(cr, 0);
...
sv_gumbelbin <- stanvar(scode = gumbelmin_dist, block = "functions") + 
  stanvar(scode = gumbelbin_stanvars, block = "functions")
